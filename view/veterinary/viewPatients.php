      ...
      <div id="content">
        ...
        for($i = 0; $i < count($patients); ++$i) {
          ...
          if (mysqli_affected_rows($con) != 0) {
              ...
              echo "<td><form action='viewClinicHistory.php' method='post'><input type='hidden' name='idPatient' value='" . $patients[$i]->getId() . "'/> <input type='hidden' name='namePatient' value='" . $patients[$i]->getName() . "'/> <center> <input type='submit' value='Ver Historia' class='btn btn-info' style='width:110px; height:35px' /> </center>  </form></td></tr>";
              $id = 0;
        } 
