      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Citas para el dia de Hoy :  <?php echo date('Y-m-d'); ?></h1> 
            ...
            <div class="card-body">
              <div class="table-responsive">
                <?php
                          ...
                          $appointments = $daoV->listAppointment($dateToday);
                          ...
                          echo "<table class='table table-bordered' id='dataTable' width='100%'' cellspacing='0'>
                              ...
                              for($i = 0; $i < count($appointments); ++$i) {
                                  ...
                                  if($appointments[$i]->getState() == "Pendiente"){
                                    $id = $appointments[$i]->getId();
                                    echo "<td><center><br><br>" . $appointments[$i]->getId() . "</td>";
                                      echo "<td><center><br><br>" . $appointments[$i]->getId_client() . "</td>";
                                      echo "<td><center><br><br>" . $appointments[$i]->getId_patient() . "</td>";
                                      echo "<td><center><br><br>" . $appointments[$i]->getDateAppointment() . "</td>";
                                      echo "<td><center><br><br>" . $appointments[$i]->getHour() . "</td>";
                                      echo "<td><center><br><br>" . $appointments[$i]->getState() . "</td>";
                                      
                                      
                                      echo "<td>
                                        <form action='addAtention.php' method='post'><input type='hidden' name='idAppointment' value='" . $appointments[$i]->getId() . "'/> <input type='hidden' name='idPatient' value='" .  $appointments[$i]->getId_patient() . "'/>  <input type='hidden' name='newState' value='Atentido'/> <center> <button type='submit' name='action' value='updateStateAppointment' class='btn btn-success' style='width:130px; height:35px'> Atentido</button> </center>  </form>

                                        <form action='../../controller/veterinaryController/VeterinaryController.php' method='post'><input type='hidden' name='appointment' value='" . $id . "'/> <input type='hidden' name='newState' value='Cancelado'/> <center> <button type='submit' name='action' value='updateStateAppointment' class='btn btn-danger' style='width:130px; height:35px'>Cancelar</button></center> </form>

                                        <form action='../../controller/veterinaryController/VeterinaryController.php' method='post'><input type='hidden' name='appointment' value='" . $id . "'/> <input type='hidden' name='newState' value='No se Presento'/><center> <button type='submit' name='action' value='updateStateAppointment' class='btn btn-info' style='width:130px; height:35px'>No se Presento</button> </center> </form></td></tr>";
                                      $id = 0;
                                  }
                                  else{
                                  //echo "<h2>No Tiene mas Citas para Hoy</h2>";
                                }
                              }
                                    ...
                                    <div class='card shadow mb-4'>
                                      <!-- Card Header - Dropdown -->
                                       <div class='card-header py-3 d-flex flex-row align-items-center center-content-between'>
                                            <form action = 'downloadAppointmentToday/' method = 'POST' target='_blank'>
                                              <input type='hidden' name='date' value='". $dateToday."'>
                                              
                                              <button type='submit'  class='btn btn-success' >Descargar Citas para el Dia de Hoy</button>
                                              </form></div>
                                    </div>
                                  </div>";
                            }else{
