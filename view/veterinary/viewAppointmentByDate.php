  ...
  <div id="wrapper">
    ...
    echo "<table class='table table-bordered' id='dataTable' width='100%'' cellspacing='0'>
        ...
        <tbody>";
                            ...
                            for($i = 0; $i < count($appointments); ++$i) {
                                ...
                                echo "<td><center>" . $appointments[$i]->getId() . "</td>";
                                  ...
                                  if(!($appointments[$i]->getState() == 'Pendiente')){echo "
                                      <form><input type='button' class='btn btn-info' style='width:130px; height:30px' />  </form></td></tr>";}
                                      else{echo "<form action='../../controller/veterinaryController/VeterinaryController.php' method='post'><input type='hidden' name='appointment' value='" . $id . "'/>  <center> <button type='submit' value='cancelAppointment' name = 'action' class='btn btn-info' style='width:130px; height:35px'>Cancelar</button> </center>  </form></td></tr>";}
                            ...
                            echo "<h2>No Tiene Citas para la Fecha Seleccionada</h2>";
                          }
