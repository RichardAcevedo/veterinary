      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="text-center">
            <center><div class="error mx-auto" data-text=":C">:C</div></center>
            <br><br>
            
            <p class="lead text-gray-800 mb-5">Sitio en Construccion, Disculpe las Molestias</p>
            <p class="text-gray-500 mb-0">Puedes Visitar otros menus de nuestra pagina</p>
            <a href="index.php">&larr; Volver al Menu Principal</a>
          </div>
