<?php 
  ...
  $query = "select count(*) from client_patient where id_client = ".$_SESSION['id']." and state ='Activo'";
  $qresult = mysqli_query($con, $query);
  $row = mysqli_fetch_assoc($qresult);
  $cantPets = $row["count(*)"];

  $query2 = "select count(*) from appointment where id_client = ".$_SESSION['id']."";
  $qresult2 = mysqli_query($con, $query2);
  $row2 = mysqli_fetch_assoc($qresult2);
  $cantAppointment = $row2["count(*)"];
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <center><div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $cantAppointment; ?></div></center>
                        </div>
