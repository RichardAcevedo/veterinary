      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Añadir Nueva Mascota</h1> 
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Datos de la Mascota</h1>
              </div>
              <form action="../../controller/clientController/ClientController.php" method='post' enctype="multipart/form-data"> 
                      ...
                      <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                          <span class="input-group-text" id="inputGroup-sizing-sm">&nbspNombre de la Mascota  :</span>
                        </div>
                      ...
                      <div class="input-group-prepend">
                        <label class="input-group-text" for="inputGroupSelect01">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspTipo de Animal :</label>
                      </div>
                      <select class="custom-select" id="inputGroupSelect01" name="type">
                       ...
                       <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                          <span class="input-group-text" id="inputGroup-sizing-sm">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspRaza  :</span>
                        </div>
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Raza : " value="" name="breed">
                      </div>

                     <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        <label class="input-group-text" for="inputGroupSelect01">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspSexo :</label>
                      </div>
                      <select class="custom-select" id="inputGroupSelect01" name="sex">
                        ...
                        <option value="Macho">Macho</option>
                           ...
                           <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                          <span class="input-group-text" id="inputGroup-sizing-sm">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspEdad de la Mascota  :</span>
                        </div>
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Edad de la Mascota" value="" name="age">
                      </div>                
                      ...
                      <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4">Agregar Foto de la Mascota</h1>
                      </div>
                      
                      <center>
                        <div> 
                        <input type="file" placeholder="Foto de la Mascota" name="file">
                      </div>
                      </center>
                    ...
                    <br>
                      ...
                      <div>
                        <center><button type="submit" class="btn btn-primary" name="action" value="addPatient">Añadir Mascota</button></center>
                      </div>
