      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Solicitar Cita Medica</h1> 
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Datos de la Cita</h1>
              </div>
              <form action="../../controller/clientController/ClientController.php" method='post'>  
                ...
                <div class="input-group mb-2">
                      <div class="input-group-prepend">
                        <label class="input-group-text" for="inputGroupSelect01">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspMascota :</label>
                      </div>
                      <select class="custom-select" id="inputGroupSelect01" name="patient">
                        <option selected>Seleccione la Mascota..</option>
                          <?php 
                          ...
                          for($i = 0; $i < count($patients); ++$i) {
                              $id = $patients[$i]->getId();
                                ...
                                echo "
                                  ...
                                  <option value = ".$id.">".$patients[$i]->getName()."</option>

                              ";
                          }
                        }else{
                          echo "<option>No Tiene Mascotas Asociadas</option>";
                        }
                    ?>
                ...
                <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                          <span class="input-group-text" id="inputGroup-sizing-sm">&nbsp&nbsp&nbspFecha de la Cita :</span>
                        </div>
                        <input type="date"  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Fecha"  name="date">
                  </div>

<br>
                <div class="input-group mb-2">
                      <div class="input-group-prepend">
                        <label class="input-group-text" for="inputGroupSelect01">Hora de la Cita :</label>
                      </div>
                    ...
                    <option value = "11 A.M - 12 M">11 A.M - 12 M</option>
            ...
            <br>
                <div>
                  <center><button class="btn btn-primary" type="submit" name="action" value="addAppointment">Agregar Cita</button></center>
                </div>
