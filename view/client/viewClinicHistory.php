<?php 
  ...
  $query = "select id_history from clinic_history where id_patient = ".$_POST['patient']." ";
            ...
            if (mysqli_affected_rows($con) != 0) {
                ...
                echo "<div class='col-xl-12 col-lg-7'>
                      <div class='card shadow mb-4'>
                        ...
                        <button type='submit' name = 'idPatient' value='".$_POST['patient']."' class='btn btn-success' >Descargar Todo el Historial Clinico</button>
                        </form>
                        </div>
                      </div>
                    </div>";
