      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Cambiar Imagen de Perfil de Mascota con ID : <?php echo $id; ?></h1> 
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Cambiar Imagen</h1>
              </div>
              ...
              <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                          <span class="input-group-text" id="inputGroup-sizing-sm">&nbsp&nbsp&nbsp&nbspIdentificación Mascota  :</span>
                        </div>
              ...
              <br>
              <br>
              <center><button type="submit" name = "action" value="editPicturePatient" class="btn btn-primary" >Cargar Imagen</button></center>
