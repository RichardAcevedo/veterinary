<?php 
  ...
  $routeImg = "../../img/imgPets/".$picture."";


  if($picture == "" && $type == "Perro"){
      $imagen = "canStandar.jpg";
      $routeImg = "../../img/imgPets/".$imagen."";
    }else if($picture == "" && $type == "Gato"){
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Perfil de <?php echo $namePatient; ?> </h1> 
              ...
              <div class="card shadow mb-9">
                ...
                <div class="card-body">
                  <div class="chart-area">
                    <form action="viewEditProfilePatient.php" method='post' enctype="multipart/form-data"> 
                      ...
                      <div class="input-group input-group-sm mb-2">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Identificación : " value="<?php echo $idPatient; ?>" name="id" readonly>
                      </div>
                      ...
                      <div class="input-group input-group-sm mb-2">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Nombre" value="<?php echo $namePatient; ?>" name="name" readonly>
                      </div>
                       ...
                       <div class="input-group input-group-sm mb-2">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Apellido : " value="<?php echo $type; ?>" name="type" readonly>
                      </div>
                       ...
                       <div class="input-group input-group-sm mb-2">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" pplaceholder="Apellido : " value="<?php echo $breed; ?>" name="breed" readonly>
                      </div>
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Telefono : " value="<?php echo $sex; ?>" name="sex" readonly>
                      </div>  
                      ...
                      <div class="input-group input-group-sm mb-2">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Telefono : " value="<?php echo $age; ?>" name="age" readonly>
                      </div> 
 
                      <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                          <span class="input-group-text" id="inputGroup-sizing-sm">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspImagen  :</span>
                        </div>
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="<?php if($picture == "") {echo "Sin imagen";} ?>" value="<?php echo $picture; ?>" name="picture" readonly>
                      </div> 
