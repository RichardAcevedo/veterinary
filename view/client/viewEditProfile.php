                    ...
                    <form action="../../controller/clientController/ClientController.php" method='post' enctype="multipart/form-data"> 
                      ...
                      <div class="input-group input-group-sm mb-2">
                       ...
                       <div class="input-group input-group-sm mb-2">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Nombre" value="<?php echo $_SESSION['name']; ?>" name="name" >
                      </div>  
                      ...
                      <div class="input-group input-group-sm mb-2">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Apellido : " value="<?php echo $_SESSION['lastName']; ?>" name="lastName" >
                      </div>  
                     ...
                     <div class="input-group input-group-sm mb-2">
                      ...
                      <div class="input-group input-group-sm mb-2">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Telefono : " value="<?php echo $_SESSION['phone']; ?>" name="phone" >
                      </div>                       
                      ...
                      <div class="input-group input-group-sm mb-2">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Respuesta Secreta : " value="<?php echo $_SESSION['secretAnswer']; ?>" name="secretAnswer" >
                      </div>
                      ...
                      <div class="input-group input-group-sm mb-2">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Correo Electronico" value="<?php echo $_SESSION['mail']; ?>" name="mail" >
                      </div>

                      <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                          <span class="input-group-text" id="inputGroup-sizing-sm">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspImagen : </span>
                        </div>
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Sin Imagen" value="<?php echo $_SESSION['picture']; ?>" name="picture" readonly>
                      </div>
                     ...
                     <br>
                      ...
                      <div>
                        <center><button type="submit" class="btn btn-primary"  name="action" value="editProfile">Guardar Cambios</button></center>
                      </div>
            ...
            <div class="col-xl-4 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <br>
                  <br>
                  <form action="viewChangePicture.php" method="POST" >
                        <center><button class="btn btn-primary" type="submit" name ="picture" value = "<?php echo $_SESSION['picture']; ?>">Cambiar Imagen</button></center>
                  </form>
                </div>
              </div>
            </div>
