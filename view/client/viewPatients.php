      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Mascotas de <?php echo $name; echo " "; echo $lastName; ?> </h1> 
        ...
        //$daoP = new PatientDAO();
        $patients = $daoP->listPatientsOfClient($_SESSION['id']);
        if($patients != NULL){
          for($i = 0; $i < count($patients); ++$i) {
              $idPatient = $patients[$i]->getId();
                ...
                echo "<td ><center><br><br>" . $patients[$i]->getId() . "</center></td>";
                echo "<td><center><br><br>" . $patients[$i]->getName() . "</center></td>";
                echo "<td><center><br><br>" . $patients[$i]->getType() . "</center></td>";
                echo "<td><center><br><br>" . $patients[$i]->getBreed() . "</center></td>";
                echo "<td><center><br><br>" . $patients[$i]->getSex() . "</center></td>";
                echo "<td><center><br><br>" . $patients[$i]->getAge() . "</center></td>";
                echo "<td><center><br><img style='width:80px; height:80px; border-radius: 9em/9em; border: silver 2px solid;' src=".$routeImg."></center></td>";
                
                  
                echo "<td>
                  <form action='viewClinicHistory.php' method='post'><input type='hidden' name='patient' value='" . $idPatient . "'/> <input type='hidden' name='namePatient' value='" . $patients[$i]->getName() . "'/> <center> <input type='submit' value='Ver Historia Clinica  ' class='btn btn-info' style='width:160px; height:40px' /> </center>  </form>

                  <form action='viewProfilePatient.php' method='post'><input type='hidden' name='patient' value='" . $idPatient . "'/> <center> <input type='submit' value='Editar Información' class='btn btn-warning' style='width:160px; height:40px' /> </center> </form>

                  <form action='../../controller/clientController/ClientController.php' method='post'><input type='hidden' name='idPatient' value='" . $id . "'/> <center> <button type='submit' name = 'action' value = 'deletePatient' class='btn btn-danger' style='width:160px; height:40px' >Eliminar Mascota</button> </center> </form></td></tr>";
                $id = 0;
          }
        }else{
          echo "<h2>No tiene Mascotas Asociadas</h2>";
        }
