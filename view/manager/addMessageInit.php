    ...
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 d-none d-lg-block "><center><img src="../../img/other/chat.png" style="width: 300px; height: 300px;"></center></div>
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form action="addMessage.php" method='post' enctype="multipart/form-data"> 
                    ...
                    <div class="input-group input-group-sm mb-2">
                     ...
                     <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        <label class="input-group-text" for="inputGroupSelect01">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspRol de Destino :</label>
                      </div>
                     ...
                     <input type="hidden" name="id_destination" value = "">
