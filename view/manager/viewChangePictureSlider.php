<?php
    ...
    $img = $_POST['picture'];
    $routeImg = "../../img/imgClients/".$img."";
    if($img == "" && $_SESSION['sex'] == "Femenino"){
        $imagen = "clientWomenStandar.jpg";
        $routeImg = "../../img/imgClients/".$imagen."";
    }else if($img == "" && $_SESSION['sex'] == "Masculino"){
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Añadir imagen a Panel Deslizante</h1>
          ...
          <div class="col-lg-9">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Nombre de Imagen</h1>
              </div>
              ...
              <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                          <span class="input-group-text" id="inputGroup-sizing-sm">&nbsp&nbsp&nbsp&nbspNombre  :</span>
                        </div>
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"  name="name" >
                      </div>
              <br>
              <div class="text-center">
                      <center><h1 class="h4 text-gray-900 mb-4">Subir Archivo</h1></center>
              </div>
              <input type="file" name="file">
              <br>
              <br>
              <center><button type="submit" name = "action" value="addImageSlider" class="btn btn-primary" >Cargar Imagen</button></center>
