<?php 
  ...
  $query2 = "select count(*) from appointment";
  $qresult2 = mysqli_query($con, $query2);
  $row2 = mysqli_fetch_assoc($qresult2);
  $cantsAppointment = $row2["count(*)"];

  $query3 = "select count(*) from veterinary ";
  $qresult3 = mysqli_query($con, $query3);
  $row3 = mysqli_fetch_assoc($qresult3);
  $cantVeterinary = $row3["count(*)"];
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Historico de Citas</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Cantidad de Veterinarios</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $cantVeterinary; ?></div>
                    </div>
                    <div class="col-auto">
