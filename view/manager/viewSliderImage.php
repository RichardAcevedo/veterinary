      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Imagenes deslizantes de la Ventana Principal </h1>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" >
                  <thead>
                    <tr>
                      <th>Numero de Imagen</th>
                      <th><center>Nombre</center></th>
                      <th><center>Nombre de Archivo</center></th>
        ...
        $query  = "select * from slider_image_landing";
        $result = mysqli_query($con, $query);

        if (mysqli_affected_rows($con) != 0) {
            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
              echo "<td width='200' height='100'><center>" . $row['id_image'] . "</td>";
              echo "<td><center>" . $row['name'] . "</td>";
              echo "<td><center>" . $row['url'] . "</td>";
              $routeImg = "../../img/SliderImageLanding/".$row['url']."";
              echo "<td width='200'><center><img style='width:200px; height:100px'  src=".$routeImg."></td>";
              echo "<td>
                <form action='../../controller/administratorController/administratorController.php' method='post'><input type='hidden' name='id_image' value='" . $row['id_image'] . "'/> <center> <input type='submit' value='Eliminar Imagen' name='action' class='btn btn-danger' style='width:160px; height:40px' /> </center>  </form></td></tr>";
