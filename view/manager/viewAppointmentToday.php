                          ...
                          echo "<table class='table table-bordered' id='dataTable' width='100%'' cellspacing='0'>
                              ...
                              for($i = 0; $i < count($appointments); ++$i) {
                                  ...
                                  if($appointments[$i]->getState() == "Pendiente"){
                                    ...
                                    echo "<td><center><br>" . $appointments[$i]->getId() . "</td>";
                                      echo "<td><center><br>" . $appointments[$i]->getId_client() . "</td>";
                                      echo "<td><center><br>" . $appointments[$i]->getId_patient() . "</td>";
                                      echo "<td><center><br>" . $appointments[$i]->getDateAppointment() . "</td>";
                                      echo "<td><center><br>" . $appointments[$i]->getHour() . "</td>";
                                      echo "<td><center><br>" . $appointments[$i]->getState() . "</td></tr>";
                              ...
                              echo "<h2>No Hay Citas para Hoy</h2>";
                            }
