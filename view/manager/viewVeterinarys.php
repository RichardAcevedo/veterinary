  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" >
                  <thead>
                    <tr>
                      ...
                      <th>Tarjeta Profesional</center></th>
        ...
        $veterinarys = $daoV->listVeterinarys();
        for($i = 0; $i < count($veterinarys); ++$i) {
            $id = $veterinarys[$i]->getId();
              $imagen = $veterinarys[$i]->getPicture();
              $sex = $veterinarys[$i]->getSex();
              ...
              echo "<td>" . $veterinarys[$i]->getId() . "</td>";
              echo "<td>" . $veterinarys[$i]->getName() . "</td>";
              echo "<td>" . $veterinarys[$i]->getLastName() . "</td>";
              echo "<td>" . $veterinarys[$i]->getSex() . "</td>";
              echo "<td>" . $veterinarys[$i]->getPhone() . "</td>";
              echo "<td>" . $veterinarys[$i]->getCardProfessional() . "</td>";
              echo "<td>" . $veterinarys[$i]->getMail() . "</td>";
                                    ...
                                    <div class='card shadow mb-4'>
                                      <!-- Card Header - Dropdown -->
                                       <div class='card-header py-3 d-flex flex-row align-items-center center-content-between'>
                                            <form action = 'downloadVeterinarys/' method = 'POST' target='_blank'>
                                              <button type='submit'  class='btn btn-success' >Descargar Listado de Veterinarios</button>
                                              </form></div>
                                    </div>
                                  </div>"; 
